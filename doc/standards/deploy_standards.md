# Стандарт деплоя Python-проекта как системного инструмента. Версия 4.10.0
...
**03. Установочные скрипты:** 03.01 Установочные скрипты - общие правила - 03.02 Блок диагностики для ИИ-агента

**04. Имя и версия:** 04.01 Единый источник имени и версии

**05. Рекомендации:** 05.01 Точка входа - 05.02 Режим разработчика - 05.03 Удаление - 05.04 Чек-лист перед релизом
...
## 04.01. Единый источник имени и версии
