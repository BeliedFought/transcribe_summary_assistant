...
|-------|-------|----------------|--------|-----------|
| `glob_audit_repository` | общий | true | 2.4.0 | Двухуровневый аудит и исправление репозитория на соответствие стандарту с учетом зафиксированных оверрайдов проекта |
